...
<div class="row">
    ...
    <div class="col-md-7">
        <div class="form-group">
            ...
            <input type="datetime-local" name="published_at" class="form-control" id="checkin_at" value="{{ old('published_at', $note?->published_at) }}" placeholder="Now" />
            @error('published_at')
...
<div class="form-check form-switch">
    <input class="form-check-input" type="checkbox" name="dashboard_visible" value="1" role="switch" id="dashboard_visible" @checked($note?->dashboard_visible)>
